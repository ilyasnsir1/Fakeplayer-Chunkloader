...
public class ChunkloaderFakePlayer extends ServerPlayerEntity {
            ...
            if (this.networkHandler == null) {
                try {
                    ...
                    ChunkloaderMod.LOGGER.error(
                            ...
                            profile.getName(), e2.getMessage(), e2);
                }
            }
        }
    ...
    public boolean spawn() {
        ...
        try {
            ...
            ChunkloaderMod.LOGGER.error("Failed to spawn fake player {}: {}", getGameProfile().getName(), e.getMessage(), e);
            try {
                ...
                ChunkloaderMod.LOGGER.warn("Failed to clean up partially spawned fake player {}: {}",
                        getGameProfile().getName(), cleanup.getMessage());
            }
    ...
    public Text getName() {
        ...
        String profileName = this.getGameProfile().getName();
    ...
    @Override
    public void unlockRecipes(java.util.List<net.minecraft.registry.RegistryKey<net.minecraft.recipe.Recipe<?>>> recipes) {
    }
