...
public class ChunkloaderFakePlayer extends ServerPlayer {
    ...
    public boolean spawn() {
        ...
        try {
            ...
            ChunkloaderForgeMod.LOGGER.error("Failed to spawn fake player {}: {}", getGameProfile().name(), e.getMessage(), e);
            try {
                ...
                ChunkloaderForgeMod.LOGGER.warn("Failed to clean up partially spawned fake player {}: {}",
