...
public class ChunkloaderManager {
    ...
    private static final ChunkTicketType CHUNKLOADER_LOADING_TICKET = ChunkTicketType.PLAYER_LOADING;
    private static final ChunkTicketType CHUNKLOADER_SIMULATION_TICKET = ChunkTicketType.PLAYER_SIMULATION;
    ...
    private void activateChunkloader(ChunkloaderTarget entry, ServerWorld world, boolean allowRandomEasterEggAssign, boolean playEffects) {
        ...
        try {
            ...
            fakePlayer.lastBodyYaw = spawnYaw;
            fakePlayer.lastHeadYaw = spawnYaw;
    ...
    private void applySpawnFacing(ChunkloaderFakePlayer fakePlayer, ChunkloaderTarget entry) {
        ...
        fakePlayer.lastBodyYaw = yaw;
        fakePlayer.lastHeadYaw = yaw;
