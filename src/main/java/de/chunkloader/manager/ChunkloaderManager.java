...
public class ChunkloaderManager {
    ...
    private static final TicketType<ChunkPos> CHUNKLOADER_TICKET =
            TicketType.create("chunkloader", Comparator.comparingLong(ChunkPos::toLong));
    ...
    private static void addChunkloaderTickets(ServerLevel world, ChunkPos chunkPos, ChunkloaderTarget entry,
        ...
        world.getChunkSource().addRegionTicket(CHUNKLOADER_TICKET, chunkPos, ticketRadius, chunkPos);
    }
    ...
    private static void removeAllChunkloaderTickets(ServerLevel world, ChunkPos chunkPos, ChunkloaderTarget entry,
        ...
        world.getChunkSource().removeRegionTicket(CHUNKLOADER_TICKET, chunkPos, ticketRadius, chunkPos);
    }
    ...
    public boolean addChunkloader(int chunkX, int chunkZ, BlockPos blockPos, String name, ServerLevel world,
            String ownerName) {
        return addChunkloader(chunkX, chunkZ, blockPos, name, world, ownerName, 0);
    }
    ...
    private void activateChunkloader(ChunkloaderTarget entry, ServerLevel world, boolean allowRandomEasterEggAssign, boolean playEffects) {
        ...
        try {
            ...
            fakePlayer.setYHeadRot(normalizeSpawnYaw(entry.spawnYaw()));
            fakePlayer.setYBodyRot(normalizeSpawnYaw(entry.spawnYaw()));
    ...
    public boolean toggleChunkloaderByName(String name) {
        ...
        if (newEnabled) {
            ...
            if (existingFakePlayer != null && existingFakePlayer.isAlive()) {
                ...
                fakePlayer.setXRot(0.0F);
                fakePlayer.setYHeadRot(normalizeSpawnYaw(updatedEntry.spawnYaw()));
                fakePlayer.setYBodyRot(normalizeSpawnYaw(updatedEntry.spawnYaw()));
    ...
    private void applySpawnFacing(ChunkloaderFakePlayer fakePlayer, ChunkloaderTarget entry) {
        ...
        fakePlayer.yBodyRotO = yaw;
        fakePlayer.yHeadRotO = yaw;
    }
