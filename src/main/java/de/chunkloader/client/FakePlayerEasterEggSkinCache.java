...
public final class FakePlayerEasterEggSkinCache {
    ...
    private static final Identifier SKIN_0 = Identifier.tryParse(ChunkloaderForgeMod.MOD_ID + ":skins/zedoy");
    private static final Identifier SKIN_1 = Identifier.tryParse(
