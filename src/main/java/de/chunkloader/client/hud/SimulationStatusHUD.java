...
public class SimulationStatusHUD {
    ...
    public static void render(GuiGraphics graphics, int screenWidth, int screenHeight) {
        ...
        int borderColor = hasData && lastStatus.inSimulatedChunk() ? 0xFF00FF00 : 0xFFFF0000;
        ...
        if (!hasData) {
            Component statusText = Component.literal("● Simulation Distance").withStyle(ChatFormatting.YELLOW,
                    ChatFormatting.BOLD);
        ...
        } else if (lastStatus.inSimulatedChunk()) {
            Component statusText = Component.literal("● Simulation: ACTIVE").withStyle(ChatFormatting.GREEN,
                    ChatFormatting.BOLD);
            graphics.drawString(font, statusText, textX, textY, 0xFFFFFFFF, false);
            ...
            if (lastStatus.fakeplayerName() != null && !lastStatus.fakeplayerName().isEmpty()) {
                ...
                Component fakeplayerValue = Component.literal(lastStatus.fakeplayerName())
            ...
            Component sdValue = Component.literal(lastStatus.simulationDistance() + " chunks")
                    .withStyle(ChatFormatting.WHITE);
            ...
            Component statusText = Component.literal("● Simulation: INACTIVE").withStyle(ChatFormatting.RED,
                    ChatFormatting.BOLD);
            graphics.drawString(font, statusText, textX, textY, 0xFFFFFFFF, false);
