...
public class ChunkMapScreen extends Screen {
    ...
    public void render(GuiGraphics context, int mouseX, int mouseY, float delta) {
        ...
        renderHoverTooltips(context, mouseX, mouseY);
    }
    ...
    private void renderHoverTooltips(GuiGraphics context, int mouseX, int mouseY) {
        if (colorEditorOverlay != null) {
            return;
        }
    ...
    private static void blitNonAtlas(
        ...
        try {
            g.blit(RenderType::guiTextured, texture, x, y, u, v, width, height, uWidth, vHeight, textureWidth, textureHeight, 0xFFFFFFFF);
