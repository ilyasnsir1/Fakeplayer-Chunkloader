...
public class ChunkMapHelpScreen extends Screen {
    ...
    public ChunkMapHelpScreen(Screen parent) {
        ...
        helpLines.add(Text.literal("This screen shows what your player is keeping loaded."));
        ...
        helpLines.add(Text.literal("Quick info about your player and where it is."));
        ...
        helpLines.add(Text.literal("Mob target:").formatted(Formatting.YELLOW)
        ...
        helpLines.add(Text.literal("Live markers:").formatted(Formatting.YELLOW)
        ...
        helpLines.add(Text.literal("Panel color:").formatted(Formatting.YELLOW)
            .append(content(" Opens the color editor. Click ? (top-left in the editor) for usage details")));
        helpLines.add(Text.literal("Skin:").formatted(Formatting.YELLOW)
        ...
        helpLines.add(Text.literal("Loaded by this player"));
        helpLines.add(Text.literal("Outside of this player"));
        helpLines.add(Text.literal("Inside radius/SD (enable to load)"));
        helpLines.add(Text.empty());
        helpLines.add(Text.literal("Map Navigation:").formatted(Formatting.BOLD, Formatting.YELLOW));
        helpLines.add(Text.literal("Rotate map:").formatted(Formatting.YELLOW)
            .append(content(" Left-click the map grid to rotate 90° clockwise (N→W→S→E→N)")));
        helpLines.add(Text.literal("Compass:").formatted(Formatting.YELLOW)
            .append(content(" The label above the map shows the current top direction")));
        helpLines.add(Text.literal("Auto-orientation:").formatted(Formatting.YELLOW)
            .append(content(" The map opens facing the cardinal direction you are looking when clicking a player")));
        helpLines.add(Text.literal("Spawn direction:").formatted(Formatting.YELLOW)
