...
public class ClientConfig {
        ...
        if (configFile.exists()) {
            try (FileReader reader = new FileReader(configFile)) {
                ...
                if (json.has("chunkMapLayoutPreset")) {
                    try {
                        String raw = json.get("chunkMapLayoutPreset").getAsString();
                        config.chunkMapLayoutPreset = (raw == null || raw.isBlank()) ? DEFAULT_CHUNKMAP_LAYOUT_PRESET : raw;
                    } catch (Exception e) {
    ...
    public void save() {
        ...
        try {
            ...
            json.addProperty("chunkMapLayoutPreset", chunkMapLayoutPreset != null ? chunkMapLayoutPreset : DEFAULT_CHUNKMAP_LAYOUT_PRESET);
    ...
    public void setChunkMapLayoutPreset(String preset) {
        this.chunkMapLayoutPreset = preset != null ? preset : DEFAULT_CHUNKMAP_LAYOUT_PRESET;
        save();
    }
    ...
    public void resetToDefaults() {
        ...
        scrollbarTrackColor = DEFAULT_SCROLLBAR_TRACK_COLOR;
        scrollbarThumbColor = DEFAULT_SCROLLBAR_THUMB_COLOR;
        leftPanelTextColor = DEFAULT_LEFT_PANEL_TEXT_COLOR;
        leftPanelValueColor = DEFAULT_LEFT_PANEL_VALUE_COLOR;
        leftPanelNameColor = DEFAULT_LEFT_PANEL_NAME_COLOR;

        actionSearchBackgroundColor = DEFAULT_ACTION_SEARCH_BACKGROUND_COLOR;
        actionSearchBorderColor = DEFAULT_ACTION_SEARCH_BORDER_COLOR;
        actionSearchTextColor = DEFAULT_ACTION_SEARCH_TEXT_COLOR;
        actionSearchPlaceholderColor = DEFAULT_ACTION_SEARCH_PLACEHOLDER_COLOR;

        chunkMapLayoutPreset = DEFAULT_CHUNKMAP_LAYOUT_PRESET;
