    ...
    public void onInitializeClient() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (client.player != null) {
                ...
                if (disabledChunkloadersKey.consumeClick()) {
                    if (client.screen == null) {
        ...
        ClientPlayNetworking.registerGlobalReceiver(OpenChunkMapPayload.TYPE, (payload, context) -> {
            context.client().execute(() -> {
                ...
                ChunkMapScreen existingScreen = ChunkMapSessionScreens.findChunkMapScreen(context.client().screen);
                ...
                (payload, context) -> {
                    context.client().execute(() -> {
                        if (context.client().player != null && context
                                .client().screen instanceof EditDisabledChunkloaderCoordsScreen editScreen) {
